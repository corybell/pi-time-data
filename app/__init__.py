...
from blueprints import health_check, hydrate, relay, option, hour, minute

def create_app() -> Flask:
  container = AppContainer()
  container.wire(modules=[health_check, hydrate, relay, option, hour, minute])
  ...
  app.register_blueprint(hydrate.blueprint)
